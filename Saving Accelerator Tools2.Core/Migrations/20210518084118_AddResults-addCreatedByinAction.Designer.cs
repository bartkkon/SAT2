...
namespace Saving_Accelerator_Tools2.Core.Migrations
{
    ...
    [Migration("20210518084118_AddResults-addCreatedByinAction")]
    partial class AddResultsaddCreatedByinAction
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Saving_Accelerator_Tools2.Core.Models.Action.InterTable.Action_PNCSpecial_InterTable", b =>
                {
                    b.Property<int>("ActionID")
                        .HasColumnType("int");

                    b.Property<int>("PNCSpecID")
                        .HasColumnType("int");

                    b.HasKey("ActionID", "PNCSpecID");

                    b.HasIndex("PNCSpecID");

                    b.ToTable("Action_PNCSpecial_InterTable");
                });
            ...
            modelBuilder.Entity("Saving_Accelerator_Tools2.Core.Models.Action.InterTable.Action_Results_InterTable", b =>
                {
                    b.Property<int>("ActionID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ActionID", "ResultID");

                    b.HasIndex("ResultID");

                    b.ToTable("Action_Results_InterTable");
                });
            ...
            modelBuilder.Entity("Saving_Accelerator_Tools2.Core.Models.Action.Specification.Calculation_DB", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Saving_Accelerator_Tools2.Core.Models.Action.Specification.InterTable.PNCSPecial_PNC_ANC_InterTable", b =>
                {
                    b.Property<int>("PNC_ID")
                        .HasColumnType("int");

                    b.Property<int>("ANC_ID")
                        .HasColumnType("int");

                    b.HasKey("PNC_ID", "ANC_ID");

                    b.HasIndex("ANC_ID");

                    b.ToTable("PNCSPecial_PNC_ANC_InterTable");
                });

            modelBuilder.Entity("Saving_Accelerator_Tools2.Core.Models.Action.Specification.PNCSpecial_ANC_DB", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal>("New_Q")
                        .HasColumnType("decimal(7,4)");

                    b.Property<decimal>("New_STK")
                        .HasColumnType("decimal(8,4)");

                    b.Property<string>("Old_ANC")
                        .HasColumnType("char(9)");

                    b.Property<decimal>("Old_Q")
                        .HasColumnType("decimal(7,4)");

                    b.Property<decimal>("Old_STK")
                        .HasColumnType("decimal(8,4)");

                    b.HasKey("ID");

                    b.ToTable("PNCSpecial_ANC");
                });

            modelBuilder.Entity("Saving_Accelerator_Tools2.Core.Models.Action.Specification.PNCSpecial_PNC_DB", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Saving_Accelerator_Tools2.Core.Models.Other.PlatformCalc_DB", b =>
                {
                    ...
                    b.ToTable("PlatformCalcs");
                });

            modelBuilder.Entity("Saving_Accelerator_Tools2.Core.Models.ProductionData.Approvals2_DB", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Saving_Accelerator_Tools2.Core.Models.ProductionData.Approvals_Devision_DB", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Approvals2_Dev");
                });

            modelBuilder.Entity("Saving_Accelerator_Tools2.Core.Models.ProductionData.Approvals_IT", b =>
                {
                    b.Property<int>("Approvals_ID")
                        .HasColumnType("int");

                    b.Property<int>("Devision_ID")
                        .HasColumnType("int");

                    b.HasKey("Approvals_ID", "Devision_ID");

                    b.HasIndex("Devision_ID");

                    b.ToTable("Approvals_IT");
                });
            ...
            modelBuilder.Entity("Saving_Accelerator_Tools2.Core.Models.Action.InterTable.Action_PNCSpecial_InterTable", b =>
                {
                    b.HasOne("Saving_Accelerator_Tools2.Core.Models.Action.Action_DB", "Action")
                        .WithMany("Action_PNCSpecial")
                        .HasForeignKey("ActionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Saving_Accelerator_Tools2.Core.Models.Action.Specification.PNCSpecial_PNC_DB", "PNCSpecial")
                        .WithMany("Action_PNCSpecial")
                        .HasForeignKey("PNCSpecID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Action");

                    b.Navigation("PNCSpecial");
                });
            ...
            modelBuilder.Entity("Saving_Accelerator_Tools2.Core.Models.Action.InterTable.Action_Results_InterTable", b =>
                {
                    b.HasOne("Saving_Accelerator_Tools2.Core.Models.Action.Action_DB", "Action")
                        .WithMany("Action_Results")
                        .HasForeignKey("ActionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Saving_Accelerator_Tools2.Core.Models.Action.Specification.Calculation_DB", "Result")
                        .WithMany("Action_Results")
            ...
            modelBuilder.Entity("Saving_Accelerator_Tools2.Core.Models.Action.Specification.InterTable.PNCSPecial_PNC_ANC_InterTable", b =>
                {
                    b.HasOne("Saving_Accelerator_Tools2.Core.Models.Action.Specification.PNCSpecial_ANC_DB", "ANCChange")
                        .WithMany("PNC_ANC_Special")
                        .HasForeignKey("ANC_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Saving_Accelerator_Tools2.Core.Models.Action.Specification.PNCSpecial_PNC_DB", "PNCChange")
                        .WithMany("PNC_ANC_Special")
                        .HasForeignKey("PNC_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ANCChange");

                    b.Navigation("PNCChange");
                });
            ...
            modelBuilder.Entity("Saving_Accelerator_Tools2.Core.Models.ProductionData.Approvals_IT", b =>
                {
                    b.HasOne("Saving_Accelerator_Tools2.Core.Models.ProductionData.Approvals2_DB", "Approvals")
                        .WithMany("Devisions")
                        .HasForeignKey("Approvals_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Saving_Accelerator_Tools2.Core.Models.ProductionData.Approvals_Devision_DB", "Devision")
                        .WithMany("Devisions")
                        .HasForeignKey("Devision_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Saving_Accelerator_Tools2.Core.Models.Action.Action_DB", b =>
                {
                    ...
                    b.Navigation("Action_PNCSpecial");

                    b.Navigation("Action_Results");
